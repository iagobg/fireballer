...
# 11. Instruções para o front-end

Pra simplificar e não criar mais dependencias do front end, ele está sendo servido pelo proprio servidor da API.

Acessável por http://localhost:3000/front
